...
class CategoryCreationCommandTest {
    ...
    void test_successCategoryCreationCommand() {
        // given
        ...
        // when
        Set<ConstraintViolation<CategoryCreationCommand>> validations = validator.validate(command);
    ...
    void test_failCategoryCreationCommand_NoName() {
        // given
        CategoryCreationCommand command = CategoryCreationCommand.builder()
                .build();
