...
class ActorUpdateCommandTest {
    ...
    void test_successActorUpdateCommand() {
        // given
        ...
        // when
        Set<ConstraintViolation<ActorUpdateCommand>> validations = validator.validate(command);
    ...
    void test_failActorUpdateCommand_NoFirstName() {
        // given
        ActorUpdateCommand command = ActorUpdateCommand.builder()
                .lastName("last name")
                .build();
    ...
    void test_failActorUpdateCommand_NoLastName() {
        // given
        ActorUpdateCommand command = ActorUpdateCommand.builder()
                .firstName("first name")
                .build();
