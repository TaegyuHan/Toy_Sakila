...
class LanguageCreationCommandTest {
    ...
    void test_successLanguageCreationCommand() {
        // given
        ...
        // when
        Set<ConstraintViolation<LanguageCreationCommand>> validations = validator.validate(command);
    ...
    void test_failLanguageCreationCommand_NoFirstName() {
        // given
        LanguageCreationCommand command = LanguageCreationCommand.builder()
                .build();
